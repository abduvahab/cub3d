...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/01 17:19:29 by averon            #+#    #+#             */
/*   Updated: 2022/11/29 14:30:38 by averon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_printf_hexa(unsigned long nb, char format);
int				ft_hexa_len(unsigned long nb);
int				ft_printf_ptr(uintptr_t ptr);
void			ft_putptr_base(uintptr_t nb, char *base);
